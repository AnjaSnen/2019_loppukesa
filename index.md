 ...
 * <script>
   if (doodleSent) {
    if (timing["demo"]) {
      ...
      document.write("Doodle linkki demotilaisuuden aikatauluttamiseksi on lähetetty kurssille ilmoittautuneille opiskelijoille. Sähköposti on lähtenyt siihen osoitteseen, joka on weboodiin rekisteröity.")
    }
   } else {
